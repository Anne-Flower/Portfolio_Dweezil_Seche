...
import CustomCursorBar from "@/components/Atomes/Cursor/CustomCursorBar";
...
const BarImage3D: FC<BarImage3DProps> = ({ label, isVisible, onToggle }) => {
  ...
  // const [visibleCursorBar, setIsVisibleCursorBar] = useState(false);

  // const [cursorBarPosition, setCursorBarPosition] = useState({ x: 0, y: 0 });
  // useEffect(() => {
  //   const handleMouseMove = (event: MouseEvent) => {
  //     setCursorBarPosition({ x: event.clientX, y: event.clientY });
  //   };
  ...
  return (
    <>
      {" "}
      {/* {visibleCursorBar && (
        <CustomCursorBar x={cursorBarPosition.x} y={cursorBarPosition.y} />
      )} */}
      <div className="z-40 cursor-pointer " onClick={onToggle}>
        ...
        >
          {/* <div
            ...
            onMouseEnter={() => setIsVisibleCursorBar(true)}
            onMouseLeave={() => setIsVisibleCursorBar(false)}
          > */}
          <h3
        ...
        {isVisible && (
          <div className="flex flex-col md:flex-row pt-0 md:pt-12 bg-white2 md:relative md:h-[426px] h-screen overflow-y-auto ">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <p className="md:w-[760px] md:h-[209px] h-auto w-[300px] pt-8 md:pt-0 pb-6 md:pb-0 md:mr-48">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu
                malesuada magna, in maximus dui. Ut rutrum pharetra neque
                lobortis maximus. Vivamus eu malesuada velit. Duis fermentum
                iaculis bibendum. Integer vel ipsum metus. Praesent dui libero,
                tempor ac sodales ut, maximus ut massa. Vestibulum iaculis, nisi
                sit amet interdum rhoncus, nisi nulla eleifend elit, sed
                interdum risus odio et felis. In faucibus arcu vel nisl congue,
                nec aliquam lectus porttitor. Morbi in lacus blandit magna
                fringilla venenatis. Sed volutpat ante a massa laoreet, vel
                sagittis ex viverra. Curabitur scelerisque fermentum justo, eget
                euismod risus pellentesque id. Phasellus ut egestas magna, vitae
                hendrerit sapien. Vestibulum aliquam, augue quis tempor aliquet,
                leo mauris aliquet nisi, ac volutpat sem sapien quis est. Orci
