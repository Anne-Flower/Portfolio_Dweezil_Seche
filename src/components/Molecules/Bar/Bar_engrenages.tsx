...
const BarEngrenages: FC<BarEngrenagesProps> = ({ label }) => {
  ...
  return (
    <Link href={"/engrenages"}>
      <motion.div
        className="md:flex md:flex-row items-center border-t-[1px] border-white2 fond3fix text-white2 w-full pr-2 pl-2 lg:pr-0 lg:pl-0 md:h-[80px] h-[110px] hover:text-lime-950 fond3fix"
        style={{
          opacity: "10px",
