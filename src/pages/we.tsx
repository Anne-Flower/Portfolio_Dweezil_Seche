  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="bg-[url('/assets/img/header/header_wesh.png')] md:w-screen md:h-screen md:min-w-[684px] overflow-clip bg-cover w-screen bg-center">
            ...
            >
              <div className="flex flex-col items-center text-white2  w-screen md:w-screen">
                ...
                <section className="flex flex-col gap-y-4 items-center md:pt-12 pt-6 md:hidden visible">
          ...
          <div>
            ...
            <Link href={"/engrenages"}>
              ...
              >
                ...
                <div className="bg-[url('/assets/img/header/header_engrenages.png')]  md:min-w-[684px]  w-screen h-[600px] md:h-screen md:w-screen bg-cover bg-center relative overflow-clip bg-white2">
                  <div className="flex flex-col items-center text-white2">
                    <h1 className="general font-thin	text-[56px] md:text-[120px] leading-[178px] pt-40 ">
                      ENGRENAGES
                    </h1>
