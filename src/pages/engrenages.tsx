...
const engrenage = () => {
  ...
  return (
    <>
      ...
      <main className="bg-[url('/assets/img/header/header_engrenages.png')] md:w-screen md:h-screen min-w-[684px] overflow-clip bg-cover relative ">
        ...
        >
          <div className="flex flex-col items-center text-white2 w-fit md:w-screen">
            <h1 className="general font-thin	text-[90px] md:text-[120px] leading-[178px] pt-40 ">
              ENGRENAGES
            </h1>
            <p className="menca md:w-[670px] w-fit px-4 text-center pt-2 ">
              WE.SH est un petit festival organisé chaque année depuis 4 ans par
              un petit groupe d'amis et de volontaires : We Are Shinny. Chaque
              année, ce petit festival prend de l'ampleur et l'organisation est
              sérieuse. Cette année, j'ai eu la chance de pouvoir travailler sur
              la communication visuelle avec une équipe de personnes extrêmement
              talentueuses.
            </p>
      ...
      <section className="md:h-[400px] bg-white2 md:pl-20 px-10 min-w-[684px]">
        <div className="md:h-[209px] md:w-[672px] py-16 bg-white2 ">
          ...
          maximus. Vivamus eu malesuada velit. Duis fermentum iaculis bibendum.
          Integer vel ipsum metus. Praesent dui libero, tempor ac sodales ut,
          maximus ut massa. Vestibulum iaculis, nisi sit amet interdum rhoncus,
          nisi nulla eleifend elit, sed interdum risus odio et felis. In
          faucibus arcu vel nisl congue, nec aliquam lectus porttitor. Morbi in
          lacus blandit magna fringilla venenatis. Sed volutpat ante a massa
          laoreet, vel sagittis ex viverra. Curabitur scelerisque fermentum
          justo, eget euismod risus pellentesque id. Phasellus ut egestas magna,
          vitae hendrerit sapien. Vestibulum aliquam, augue quis tempor aliquet,
          leo mauris aliquet nisi, ac volutpat sem sapien quis est. Orci varius
      ...
      <Link href={"/naturia"}>
        ...
        >
          ...
          <div className="bg-[url('/assets/img/header/header_naturIA.png')] min-w-[684px] md:w-screen h-[600px] md:h-screen md:-screen bg-cover bg-center relative overflow-clip ">
            <div className="flex flex-col items-center text-white2  ">
              ...
              <p className="menca lg:w-[670px] px-4 text-center pt-2 ">
                ...
                tristique. Sed ut faucibus massa. Aenean eu mauris ullamcorper,
                malesuada nisl id, porta arcu. Pellentesque vitae rutrum sapien.
                Nunc nec tincidunt nunc. Vestibulum ac eros non velit luctus
                laoreet id eu urna. Suspendisse tortor ex, aliquam id magna
                vitae, tincidunt dignissim purus. Praesent interdum tempus orci
                non varius.
              </p>
